...
################################################################################################
    ...
    if mode == 1:
        ...
        diff_654 = int((1.2*midpoint[6]-0.2*midpoint[5]-0.2*midpoint[4]-0.2*midpoint[3])//div//imgh//3)
        dif_angle = np.arctan2(3*imgh//8,diff_654*8//3//imgh)-np.pi//2
        cv.arrowedLine(color_image, (imgw//2-diff_654//2,13*imgh//16),(imgw//2+diff_654//2,9*imgh//16),(255,255,0),3)
        print(dif_angle)
